!(function (a, b) {
  ...
  function b(a) {
    ...
    for (
      ...
      g > h &&
      ((c = f[h]),
      -1 === c.search(/^(http|https|ftp):\/\//) && -1 !== c.search(":"));
      h++
    )
      (b = c.indexOf(":")),
        (d = c.substring(0, b)),
  ...
  (e.prototype.init = function () {
    ...
    (e.$wrapper = a("<div>").css({
      ...
      "object" == typeof e.path &&
        (e.path.poster
          ...
          : e.path.webm
          ? (b = e.path.webm)
          : e.path.ogv && (b = e.path.ogv)),
      "detect" === e.settings.posterType
        ? d(b, function (a) {
            e.$wrapper.css("background-image", "url(" + a + ")");
          })
        : "none" !== e.settings.posterType &&
          e.$wrapper.css(
            "background-image",
            "url(" + b + "." + e.settings.posterType + ")"
          ),
      "static" === e.$element.css("position") &&
        e.$element.css("position", "relative"),
      e.$element.prepend(e.$wrapper),
      "object" == typeof e.path
        ? (e.path.mp4 &&
            (h += '<source src="' + e.path.mp4 + '.mp4" type="video/mp4">'),
          e.path.webm &&
            (h += '<source src="' + e.path.webm + '.webm" type="video/webm">'),
          e.path.ogv &&
            (h += '<source src="' + e.path.ogv + '.ogv" type="video/ogv">'),
          (e.$video = a("<video>" + h + "</video>")))
        : (e.$video = a(
            '<video><source src="' +
              e.path +
      ...
      e.$video
        ...
        .one("playing." + f, function () {
          e.$video.css("visibility", "visible"),
            e.$wrapper.css("background-image", "none");
        }),
    ...
    (e.prototype.resize = function () {
      if (this.$video) {
        ...
        this.$video.css(
          d / b > c / a
            ? { width: d + 2, height: "auto" }
            : { width: "auto", height: c + 2 }
        );
      }
    }),
